...
set CLASSPATH=%APP_HOME%\lib\Kotlin-CLI-1.0-SNAPSHOT.jar;%APP_HOME%\lib\kotlinx-serialization-json-jvm-1.7.0.jar;%APP_HOME%\lib\kotlinx-serialization-core-jvm-1.7.0.jar;%APP_HOME%\lib\kotlin-stdlib-jdk7-1.9.23.jar;%APP_HOME%\lib\clikt-mordant-markdown-jvm.jar;%APP_HOME%\lib\clikt-mordant-jvm.jar;%APP_HOME%\lib\clikt-jvm.jar;%APP_HOME%\lib\mordant-omnibus-jvm.jar;%APP_HOME%\lib\mordant-markdown-jvm.jar;%APP_HOME%\lib\mordant-jvm-jna-jvm.jar;%APP_HOME%\lib\mordant-jvm-ffm-jvm.jar;%APP_HOME%\lib\mordant-jvm-graal-ffi-jvm.jar;%APP_HOME%\lib\mordant-jvm.jar;%APP_HOME%\lib\markdown-jvm-0.7.3.jar;%APP_HOME%\lib\colormath-jvm.jar;%APP_HOME%\lib\kotlin-stdlib-2.0.10.jar;%APP_HOME%\lib\kotlin-stdlib-jdk8-1.9.23.jar;%APP_HOME%\lib\annotations-13.0.jar;%APP_HOME%\lib\jna-5.14.0.jar
